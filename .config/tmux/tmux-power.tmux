...
#
#      Ref: https://github.com/wfxr/tmux-power
#===============================================================================
...
if "$show_upload_speed"; then
    # RS="#[fg=$G06,bg=$G05]$left_arrow_icon#[fg=$TC,bg=$G05] $upload_speed_icon#{upload_speed} #[fg=$G05,bg=$BG]$left_arrow_icon $RS"
    RS="#[fg=$G05,bg=$BG]$left_arrow_icon#[fg=$TC,bg=$G05] $upload_speed_icon#{upload_speed} #[fg=$BG,bg=$G05]$left_arrow_icon$RS"
fi
